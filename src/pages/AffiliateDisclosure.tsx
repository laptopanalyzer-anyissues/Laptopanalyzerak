...
const AffiliateDisclosure = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="Affiliate Disclosure — LaptopAnalyzer"
        description="Affiliate disclosure for Laptop Analyzer. Transparency about how we may earn commissions through product recommendations and links."
