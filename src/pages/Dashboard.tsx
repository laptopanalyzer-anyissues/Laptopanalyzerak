...
const tests = [
  {
    icon: Monitor,
    title: "Display Test",
    description: "Dead pixels, color accuracy, and screen quality",
    path: "/test/display",
  ...
  },
  {
    icon: Mouse,
    title: "Touchpad Test",
    description: "Cursor tracking, clicks, and scroll",
    path: "/test/touchpad",
  ...
  },
  {
    icon: Camera,
    title: "Camera Test",
    description: "Live webcam preview with snapshot",
    path: "/test/camera",
  ...
  },
  {
    ...
    description: "Real-time input with waveform visualization",
  ...
  },
  {
    icon: Speaker,
    title: "Speaker Test",
    description: "Left, right, and stereo channel check",
    path: "/test/audio",
  ...
  },
  {
    icon: Wifi,
    title: "Network Test",
    description: "Download, upload, ping, and jitter",
    path: "/test/network",
  ...
  },
  {
    ...
    description: "USB, audio, display, and wireless",
    path: "/test/ports",
